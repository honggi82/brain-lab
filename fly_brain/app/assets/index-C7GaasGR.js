...
void main() {
	...
	`}var ko=class extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        }`});x.add(new Oi(S,C));let w=new fr().setFromBufferAttribute(S.getAttribute(`position`)).getSize(new q),T=()=>{let{width:e,height:n}=t.getBoundingClientRect();b.setSize(Math.max(1,e),Math.max(1,n),!1);let r=Math.max(1,e)/Math.max(1,n),i=Math.max(w.x,w.y,w.z)/2*1.1;y.top=i,y.bottom=-i,y.left=-i*r,y.right=i*r,y.position.set(0,0,10),y.lookAt(0,0,0),y.updateProjectionMatrix(),b.render(v,y)},E=()=>{if(n)return;g.fill(0),_.fill(0);for(let[e,t]of o.current?.values??[]){let n=f.get(e);n!==void 0&&(g[n]=t)}for(let e of s.current){let t=f.get(e);t!==void 0&&(_[t]=1)}let e=c.current;if(e!==null){let t=f.get(e);t!==void 0&&(_[t]=2)}S.getAttribute(`activity`).needsUpdate=!0,S.getAttribute(`marker`).needsUpdate=!0,C.uniforms.hasSignal.value=+!!o.current,b.render(v,y)};l.current=E,u.current=e=>{x.rotation.set(0,e===`side`?Math.PI/2:0,0),T()};let D=e=>{let t=b.domElement.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,a=-((e.clientY-t.top)/t.height)*2+1;x.updateMatrixWorld();let o=new mn().multiplyMatrices(y.projectionMatrix,y.matrixWorldInverse).multiply(x.matrixWorld),s=new q,c=-1,l=1/0;for(let e=0;e<r;e++){s.set(i[e*3],i[e*3+1],i[e*3+2]).applyMatrix4(o);let t=s.x-n,r=s.y-a,u=t*t+r*r;if(u>9e-4)continue;let d=u*(1-Math.min(.85,Math.abs(g[e])));d<l&&(l=d,c=e)}c>=0&&h.current(d[c],e.shiftKey)},O=!1,k=!1,A=0,j=0,M=e=>{O=!0,k=!1,A=e.clientX,j=e.clientY,b.domElement.setPointerCapture(e.pointerId)},ee=e=>{if(!O)return;let t=e.clientX-A,n=e.clientY-j;Math.abs(t)+Math.abs(n)>3&&(k=!0),x.rotation.y+=t*.006,x.rotation.x+=n*.006,A=e.clientX,j=e.clientY,T()},te=e=>{O&&!k&&D(e),O=!1},N=b.domElement;N.addEventListener(`pointerdown`,M),N.addEventListener(`pointermove`,ee),N.addEventListener(`pointerup`,te),N.addEventListener(`pointercancel`,()=>{O=!1});let P=new ResizeObserver(T);P.observe(t),T(),E();let F=0,ne=performance.now(),re=window.matchMedia(`(prefers-reduced-motion: reduce)`),ie=e=>{let t=Math.min(.05,(e-ne)/1e3);ne=e,p.current&&!O&&!re.matches&&!document.hidden&&(x.rotation.y+=t*.12,b.render(v,y)),F=requestAnimationFrame(ie)};return F=requestAnimationFrame(ie),()=>{n=!0,l.current=null,u.current=null,cancelAnimationFrame(F),P.disconnect(),N.removeEventListener(`pointerdown`,M),N.removeEventListener(`pointermove`,ee),N.removeEventListener(`pointerup`,te),S.dispose(),C.dispose(),b.dispose(),N.remove()}},[e]),(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsxs)(`div`,{className:`brain-view-controls`,children:[(0,Q.jsx)(`button`,{onClick:()=>{p.current=!1,f(!1),u.current?.(`front`)},children:m(`cns.front`)}),(0,Q.jsx)(`button`,{onClick:()=>{p.current=!1,f(!1),u.current?.(`side`)},children:m(`cns.side`)}),(0,Q.jsx)(`button`,{"aria-pressed":d,onClick:()=>{p.current=!p.current,f(p.current)},children:m(d?`cns.orbitOn`:`cns.orbitOff`)})]}),(0,Q.jsx)(`div`,{className:`brain-legend`,children:m(`cns.legend`)}),(0,Q.jsx)(`div`,{ref:a,className:`three-viewport brain-viewport`,"aria-label":m(`cns.aria`)})]})}var Sl={mode:`path`,direction:`downstream`,hops:5,decay:.85,duration:1,tau:.05,gain:2,stim:.25,min_weight:5,inhibition:1},Cl=`static-data`;async function wl(e){let t=await fetch(`./${e}`);if(!t.ok)throw Error(`${e}: ${t.status}`);return t.json()}var Tl=null;async function El(e){if(!Tl){let e=await wl(`${Cl}/labels.json`);Tl=new Map;for(let t of e.rows){let n=t[6];Tl.set(t[0],{bodyId:t[0],name:t[1],role:t[2],part:t[3],side:t[4],nt:t[5],population:n>=0?e.populations[n]:null})}}return Tl.get(e)??null}var Dl=e=>`pop-${e.replace(/:/g,`_`).replace(/ /g,`-`).replace(/\//g,`-`)}`,Ol=async()=>(await wl(`${Cl}/index.json`)).meta,kl=()=>wl(`${Cl}/circuit.json`),Al=[1,2,3,4,5],jl=e=>Math.min(Math.max(e,Al[0]),Al[Al.length-1]),Ml=(e,t)=>wl(e.mode===`rate`?`${Cl}/runs/preset-${e.id}.json`:`${Cl}/runs/preset-${e.id}-h${jl(t.hops)}.json`),Nl=(e,t)=>wl(`${Cl}/runs/${Dl(e)}-h${jl(t.hops)}.json`),Pl=class extends Error{},Fl=()=>wl(`${Cl}/nodes.json`),Il=(e,t,n=[])=>Promise.reject(new Pl(`static`)),Ll={sensory:`#dfb672`,early:`#81b5c8`,brain:`#9aa8c4`,bridge:`#dfb672`,cord:`#af9bc3`,motor:`#6fd3c0`},Rl=`#5fd8ef`,zl=`#ff9a63`,Bl=`#c99ae0`,Vl=`visual.olfactory.gustatory.head mechano.head other.neck.wing.haltere.abdomen.L front leg.R front leg.L middle leg.R middle leg.L hind leg.R hind leg.optic lobe.lobula output.antennal lobe.gnathal ganglion.ventrolateral protocerebrum.superior protocerebrum.lateral accessory / posterior.mushroom body.central complex.other central.descending.ascending.T1.T2.T3.A.other.head.efferent`.split(`.`),Hl=1400,Ul=52,Wl=26,Gl=150;function Kl(e){let t=Math.max(...e.nodes.map(e=>e.count),1),n=e=>16+28*Math.sqrt(e.count/t),r=e=>{let t=Vl.indexOf(e.label);return t<0?900-Math.min(800,e.count/100):t},i=e.layers.map((t,n)=>90+n*(1180/(e.layers.length-1))),a=e.layers.map(t=>e.nodes.filter(e=>e.layer===t).sort((e,t)=>r(e)-r(t))),o=Math.max(...a.map(e=>e.reduce((e,t)=>e+n(t)+10,0)),1),s=Math.max(520,o+Ul+Wl),c=new Map;return a.forEach((e,t)=>{let r=e.reduce((e,t)=>e+n(t)+10,0),a=Ul+(s-Ul-Wl-r)/2;for(let r of e){let e=n(r);c.set(r.id,{node:r,x:i[t],y:a+e/2,h:e}),a+=e+10}}),{placed:c,svgHeight:s,columnX:i}}function ql({activity:e,onStimulate:t,running:n}){let{t:r,lang:i}=vl(),[a,o]=(0,_.useState)(null),[s,c]=(0,_.useState)(``),[l,u]=(0,_.useState)(4e4),[d,f]=(0,_.useState)(!0),[p,m]=(0,_.useState)(null);(0,_.useEffect)(()=>{let e=!1;return kl().then(t=>{e||o(t)}).catch(t=>{e||c(String(t))}),()=>{e=!0}},[]);let h=(0,_.useMemo)(()=>a?Kl(a):null,[a]),g=(0,_.useMemo)(()=>a?Math.max(...a.edges.map(e=>e.w),1):1,[a]);if(s)return(0,Q.jsx)(`p`,{className:`error`,children:s});if(!a||!h)return(0,Q.jsx)(`p`,{className:`muted`,style:{padding:`14px`},children:r(`circuit.loading`)});let{placed:v,svgHeight:y,columnX:b}=h,x=e=>i===`ko`?e.ko:e.label,S=a.edges.filter(e=>!(e.w<l||e.back&&!d||p&&e.s!==p&&e.t!==p)),C=new Set;for(let e of S)C.add(e.s),C.add(e.t);let w=e&&Object.keys(e).length>0?e:null,T=e=>w?Math.min(w[e.s]?.[0]??0,w[e.t]?.[0]??0):0,E=(e,t)=>{let n=v.get(e.s),r=v.get(e.t);if(!n||!r)return null;let i=n.x+(e.back?-75:Gl/2),a=r.x+(e.back?Gl/2:-75),o=Math.max(58,Math.abs(a-i)*.45);if(e.back){let e=44+t%4*16;return`M${i},${n.y} C${i+o*.7},${n.y-e} ${a-o*.7},${r.y-e} ${a},${r.y}`}return`M${i},${n.y} C${i+o},${n.y} ${a-o},${r.y} ${a},${r.y}`},D=e=>a.edges.filter(t=>t.w>=l&&(!t.back||d)&&(e===`s`?t.t:t.s)===p).sort((e,t)=>t.w-e.w).slice(0,10),O=p?a.nodes.find(e=>e.id===p)??null:null;return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsxs)(`div`,{className:`circuit-controls`,children:[(0,Q.jsxs)(`label`,{children:[r(`circuit.min`),(0,Q.jsx)(`input`,{type:`range`,min:2e3,max:4e5,step:2e3,value:l,onChange:e=>u(Number(e.target.value))}),(0,Q.jsx)(`span`,{className:`val`,children:l.toLocaleString()})]}),(0,Q.jsx)(`button`,{"aria-pressed":d,onClick:()=>f(!d),children:r(`circuit.back`)}),(0,Q.jsx)(`span`,{children:r(`circuit.shown`,{a:S.length.toLocaleString(),b:a.edges.length.toLocaleString()})}),(0,Q.jsx)(`span`,{style:{color:w?Rl:void 0},children:r(w?`circuit.live`:`circuit.idle`)})]}),(0,Q.jsxs)(`div`,{className:`circuit-body`,children:[(0,Q.jsx)(`div`,{className:`circuit-canvas`,children:(0,Q.jsxs)(`svg`,{viewBox:`0 0 ${Hl} ${y}`,role:`img`,"aria-label":`Connectome circuit, sensory populations left, motor pools right`,children:[a.layers.map((e,t)=>(0,Q.jsxs)(`g`,{children:[(0,Q.jsx)(`line`,{x1:b[t],y1:36,x2:b[t],y2:y-12,stroke:`#1e272f`}),(0,Q.jsx)(`text`,{className:`circuit-col`,x:b[t],y:24,textAnchor:`middle`,children:r(`circuit.col.${e}`)})]},e)),S.map((e,t)=>{let n=E(e,t);return n?(0,Q.jsx)(`path`,{d:n,fill:`none`,strokeLinecap:`round`,stroke:e.back?Bl:e.exc>=.5?Rl:zl,strokeWidth:.7+6.5*(e.w/g)**.45,strokeDasharray:e.back?`7 5`:void 0,opacity:w?.1+.85*T(e)**.5:p?.9:.4},`${e.s}->${e.t}`):null}),[...v.values()].map(({node:e,x:r,y:i,h:a})=>{let o=Ll[e.tag]??`#6c7777`,s=p===e.id,c=p&&!s&&!C.has(e.id),[l,u]=w?.[e.id]??[0,1],d=l>0?l**.45:0,f=u>=0?Rl:zl,h=s?o:d>.01?f:`#131920`,g=s||d>.55;return(0,Q.jsxs)(`g`,{opacity:c?.22:1,children:[(0,Q.jsx)(`rect`,{x:r-Gl/2,y:i-a/2,width:Gl,height:a,rx:3,fill:h,fillOpacity:s?1:d>.01?d:1,stroke:d>.01?f:o,strokeWidth:d>.01?1.4+d:1.4,style:{cursor:n?`wait`:`pointer`},onClick:()=>{if(!n){if(s){m(null);return}m(e.id),t(e.id,x(e))}}}),(0,Q.jsx)(`text`,{x:r-Gl/2+8,y:i+3.5,fontSize:10,fill:g?`#0b0e12`:`#d6dce3`,pointerEvents:`none`,children:x(e)}),(0,Q.jsx)(`text`,{x:r+Gl/2-8,y:i+3.5,fontSize:9,textAnchor:`end`,fill:g?`#0b0e12`:`#7f8d9e`,pointerEvents:`none`,children:e.count.toLocaleString()})]},e.id)})]})}),(0,Q.jsx)(`div`,{className:`circuit-side`,children:O?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`h3`,{children:x(O)}),(0,Q.jsxs)(`p`,{className:`sub`,children:[O.count.toLocaleString(),r(`circuit.popNeurons`),` · `,r(`circuit.col.${O.layer}`),(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`span`,{style:{color:Rl},children:r(`circuit.stimulating`)})]}),[[`circuit.inbound`,`s`],[`circuit.outbound`,`t`]].map(([e,t])=>{let n=D(t);return(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h4`,{children:r(e)}),n.length===0?(0,Q.jsx)(`p`,{className:`muted`,children:r(`circuit.none`)}):(0,Q.jsx)(`ul`,{children:n.map(e=>{let n=t===`s`?e.s:e.t,r=a.nodes.find(e=>e.id===n);return r?(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`span`,{className:`w`,children:e.w.toLocaleString()}),(0,Q.jsxs)(`span`,{className:`nm`,children:[x(r),e.back&&(0,Q.jsx)(`span`,{style:{color:Bl},children:` ↵`})]}),(0,Q.jsxs)(`span`,{className:`pol`,style:{color:e.exc>=.5?Rl:zl},children:[Math.round(e.exc*100),`%`]})]},`${e.s}->${e.t}`):null})})]},t)})]}):(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`h3`,{children:r(`circuit.pick`)}),(0,Q.jsx)(`p`,{className:`sub`,children:r(`circuit.pickSub`)})]})})]}),(0,Q.jsxs)(`div`,{className:`circuit-legend`,children:[[`sensory`,`early`,`brain`,`bridge`,`cord`,`motor`].map(e=>(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:Ll[e]}}),r(`circuit.leg.${e}`)]},e)),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{className:`bar`,style:{background:Rl}}),r(`circuit.leg.exc`)]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{className:`bar`,style:{background:zl}}),r(`circuit.leg.inh`)]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{className:`bar`,style:{background:Bl}}),r(`circuit.leg.back`)]})]})]})}var Jl={type:`change`},Yl={type:`start`},Xl={type:`end`},Zl=new ni,Ql=new Yr,$l=Math.cos(70*Ut.DEG2RAD),eu=new q,tu=2*Math.PI,$={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},nu=1e-6,ru=class extends Ja{constructor(e,t=null){super(e,t),this.state=$.NONE,this.target=new q,this.cursor=new q,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:y.ROTATE,MIDDLE:y.DOLLY,RIGHT:y.PAN},this.touches={ONE:b.ROTATE,TWO:b.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new q,this._lastQuaternion=new Wt,this._lastTargetPosition=new q,this._quat=new Wt().setFromUnitVectors(e.up,new q(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new qa,this._sphericalDelta=new qa,this._scale=1,this._panOffset=new q,this._rotateStart=new K,this._rotateEnd=new K,this._rotateDelta=new K,this._panStart=new K,this._panEnd=new K,this._panDelta=new K,this._dollyStart=new K,this._dollyEnd=new K,this._dollyDelta=new K,this._dollyDirection=new q,this._mouse=new K,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=au.bind(this),this._onPointerDown=iu.bind(this),this._onPointerUp=ou.bind(this),this._onContextMenu=pu.bind(this),this._onMouseWheel=lu.bind(this),this._onKeyDown=uu.bind(this),this._onTouchStart=du.bind(this),this._onTouchMove=fu.bind(this),this._onMouseDown=su.bind(this),this._onMouseMove=cu.bind(this),this._interceptControlDown=mu.bind(this),this._interceptControlUp=hu.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=$.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Jl),this.update(),this.state=$.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;eu.copy(t).sub(this.target),eu.applyQuaternion(this._quat),this._spherical.setFromVector3(eu),this.autoRotate&&this.state===$.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=tu:n>Math.PI&&(n-=tu),r<-Math.PI?r+=tu:r>Math.PI&&(r-=tu),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(eu.setFromSpherical(this._spherical),eu.applyQuaternion(this._quatInverse),t.copy(this.target).add(eu),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=eu.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new q(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new q(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=eu.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Zl.origin.copy(this.object.position),Zl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Zl.direction))<$l?this.object.lookAt(this.target):(Ql.setFromNormalAndCoplanarPoint(this.object.up,this.target),Zl.intersectPlane(Ql,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>nu||8*(1-this._lastQuaternion.dot(this.object.quaternion))>nu||this._lastTargetPosition.distanceToSquared(this.target)>nu?(this.dispatchEvent(Jl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?tu/60/60*this.autoRotateSpeed:tu/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){eu.setFromMatrixColumn(t,0),eu.multiplyScalar(-e),this._panOffset.add(eu)}_panUp(e,t){this.screenSpacePanning===!0?eu.setFromMatrixColumn(t,1):(eu.setFromMatrixColumn(t,0),eu.crossVectors(this.object.up,eu)),eu.multiplyScalar(e),this._panOffset.add(eu)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;eu.copy(r).sub(this.target);let i=eu.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(tu*this._rotateDelta.x/t.clientHeight),this._rotateUp(tu*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(tu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-tu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(tu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-tu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(tu*this._rotateDelta.x/t.clientHeight),this._rotateUp(tu*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new K,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function iu(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function au(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function ou(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Xl),this.state=$.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function su(e){let t;switch(e.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case y.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(e),this.state=$.DOLLY;break;case y.ROTATE:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=$.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=$.ROTATE}break;case y.PAN:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=$.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=$.PAN}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Yl)}function cu(e){switch(this.state){case $.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case $.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case $.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function lu(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===$.NONE&&(e.preventDefault(),this.dispatchEvent(Yl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Xl))}function uu(e){this.enabled!==!1&&this._handleKeyDown(e)}function du(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case b.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=$.TOUCH_ROTATE;break;case b.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=$.TOUCH_PAN;break;default:this.state=$.NONE}break;case 2:switch(this.touches.TWO){case b.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=$.TOUCH_DOLLY_PAN;break;case b.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=$.TOUCH_DOLLY_ROTATE;break;default:this.state=$.NONE}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Yl)}function fu(e){switch(this._trackPointer(e),this.state){case $.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case $.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case $.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case $.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=$.NONE}}function pu(e){this.enabled!==!1&&e.preventDefault()}function mu(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function hu(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var gu=e=>`./${e}`,_u=e=>{let t=e.match(/(T[123])_(left|right)/);if(t){let e={T1:`front leg`,T2:`middle leg`,T3:`hind leg`}[t[1]];return`${t[2]===`left`?`L`:`R`} ${e}`}return e.startsWith(`wing_`)?e.endsWith(`left`)?`L wing`:`R wing`:e.startsWith(`haltere_`)?e.endsWith(`left`)?`L haltere`:`R haltere`:e===`head`||e.startsWith(`antenna`)||e===`rostrum`||e.startsWith(`haustellum`)||e.startsWith(`labrum`)?`M neck`:e.startsWith(`abdomen`)?`M abdomen`:null},vu=e=>new Wt(e[1],e[2],e[3],e[0]);function yu({summary:e,posture:t,direction:n}){let r=(0,_.useRef)(null),i=(0,_.useRef)(t),a=(0,_.useRef)(e),o=(0,_.useRef)(null),[s,c]=(0,_.useState)(`loading`),[l,u]=(0,_.useState)(null),[d,f]=(0,_.useState)(``),{t:p,limb:m,part:h}=vl();(0,_.useEffect)(()=>{i.current=t,o.current?.()},[t]),(0,_.useEffect)(()=>{a.current=e,o.current?.()},[e]),(0,_.useEffect)(()=>{let e=r.current;if(!e)return;let t=new AbortController,n=!1,s=new Zn,l=new Hn;l.rotation.x=-Math.PI/2,s.add(l);let d=new Da(32,1,.001,100),p=new pl({antialias:!0,alpha:!0});p.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.outputColorSpace=et,e.appendChild(p.domElement),s.add(new ha(16772570,1581098,2.4));let m=new Aa(16768946,3.2);m.position.set(2,3,4),s.add(m);let h=new Aa(10147823,1.4);h.position.set(-3,1,-2),s.add(h);let g=new ru(d,p.domElement);g.enablePan=!1,g.minDistance=.4,g.maxDistance=6;let _=()=>{let{width:t,height:n}=e.getBoundingClientRect();p.setSize(Math.max(1,t),Math.max(1,n),!1),d.aspect=Math.max(1,t)/Math.max(1,n),d.updateProjectionMatrix(),p.render(s,d)};g.addEventListener(`change`,()=>p.render(s,d)),(async()=>{let e=async e=>{let n=await fetch(gu(`data/flybody-full/${e}`),{signal:t.signal});if(!n.ok)throw Error(`Flybody asset unavailable: ${e}`);return n},r=await(await e(`model.json`)).json(),f=await(await e(r.binary)).arrayBuffer();if(n)return;let m={};for(let[e,t]of Object.entries(r.materials))m[e]=new Ki({color:new Yn(t[0],t[1],t[2]),roughness:.62,metalness:.02,transparent:t[3]<1,opacity:t[3],side:t[3]<1?2:0});let h=new Ki({color:10381364,roughness:.65}),v=[],y=new Map;r.bodies.forEach((e,t)=>{let n=new Vn;n.position.fromArray(e.pos),n.quaternion.copy(vu(e.quat)),(e.parent<0?l:v[e.parent]).add(n);let i=n;for(let e of r.joints.filter(e=>e.body===t)){let t=new Vn;t.position.fromArray(e.pos);let n=new Vn;n.position.fromArray(e.pos).negate(),i.add(t),t.add(n),i=n,y.set(e.name,t)}v[t]=i});let b=new Map;for(let e of r.parts){let t=new Float32Array(f.slice(e.positionOffset,e.positionOffset+e.positionCount*12)),n=new Uint32Array(f.slice(e.indexOffset,e.indexOffset+e.indexCount*4)),i=new Gr;i.setAttribute(`position`,new Ar(t,3)),i.setIndex(new Ar(n,1)),i.computeVertexNormals();let a=new hi(i,(m[e.material]??h).clone());v[e.body].add(a);let o=_u(r.bodies[e.body].name);o&&(b.has(o)||b.set(o,[]),b.get(o).push(a))}let x=r.joints.filter(e=>e.key&&e.limb&&y.has(e.name)).map(e=>({pivot:y.get(e.name),axis:new q().fromArray(e.axis).normalize(),lower:Math.min(e.range[0],e.range[1]),upper:Math.max(e.range[0],e.range[1]),limb:e.limb,key:e.key,weight:e.weight})),S=new Map,C=new Yn(.12,.8,1),w=new Yn(1,.42,.18),T=()=>{if(n)return;let e=i.current;for(let t of x){let n=(e?.[t.limb]?.[t.key]?.angle??0)*t.weight,r=n>=0?t.upper:-t.lower;t.pivot.quaternion.setFromAxisAngle(t.axis,n*r)}let t=a.current?.motorOutput??{},r=1e-6;for(let e of Object.values(t))r=Math.max(r,e.excite-e.inhibit);for(let[e,n]of b){let i=t[e],a=(i?.excite??0)/r,o=-(i?.inhibit??0)/r,s=Math.min(1,Math.max(0,a+o)**.55);for(let e of n){let t=e.material;S.has(e)||S.set(e,t.color.clone()),t.color.copy(S.get(e)),s>.01?(t.color.lerp(a>=o?C:w,s*.85),t.emissive.copy(a>=o?C:w).multiplyScalar(s*.22)):t.emissive.setRGB(0,0,0)}}p.render(s,d)};o.current=T,l.updateMatrixWorld(!0);let E=new fr().setFromObject(l);l.position.sub(E.getCenter(new q));let D=E.getBoundingSphere(new Lr).radius;d.position.set(.85,.55,1.25).normalize().multiplyScalar(D/Math.sin(d.fov*Math.PI/360)*.85),g.target.set(0,0,0),g.update(),u({segments:r.bodies.length,joints:x.length,tris:r.outputTriangles}),c(`ready`),_(),T()})().catch(e=>{n||(c(`error`),f(String(e)))});let v=new ResizeObserver(_);return v.observe(e),_(),()=>{n=!0,o.current=null,t.abort(),v.disconnect(),g.dispose(),l.traverse(e=>{e instanceof hi&&(e.geometry.dispose(),e.material.dispose())}),p.dispose(),p.domElement.remove()}},[]);let g=Object.entries(e?.motorOutput??{}).map(([e,t])=>({limb:e,...t})).sort((e,t)=>t.excite-t.inhibit-(e.excite-e.inhibit)).slice(0,6),v=Object.entries(t??{}).flatMap(([e,t])=>Object.entries(t).map(([t,n])=>({limb:e,key:t,...n}))).sort((e,t)=>Math.abs(t.angle)-Math.abs(e.angle)).slice(0,8);return(0,Q.jsxs)(`div`,{className:`flybody`,children:[(0,Q.jsx)(`div`,{ref:r,className:`flybody-view`,"aria-label":p(`body.aria`),children:s!==`ready`&&(0,Q.jsx)(`span`,{className:`neural-load`,role:`status`,children:s===`error`?d:p(`body.loading`)})}),(0,Q.jsxs)(`div`,{className:`flybody-side`,children:[(0,Q.jsx)(`p`,{className:`bodymap-caption`,children:p(n===`upstream`?`body.captionUp`:`body.captionDown`)}),g.length===0?(0,Q.jsx)(`p`,{className:`muted`,children:p(`body.noMotor`)}):(0,Q.jsxs)(`table`,{className:`bodymap-table`,children:[(0,Q.jsx)(`thead`,{children:(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`th`,{children:p(`body.limb`)}),(0,Q.jsx)(`th`,{children:p(`body.drive`)}),(0,Q.jsx)(`th`,{children:p(`body.brake`)}),(0,Q.jsx)(`th`,{children:p(`body.active`)})]})}),(0,Q.jsx)(`tbody`,{children:g.map(e=>(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`td`,{children:m(e.limb)}),(0,Q.jsx)(`td`,{className:`pos`,children:e.excite.toFixed(3)}),(0,Q.jsx)(`td`,{className:`neg`,children:e.inhibit.toFixed(3)}),(0,Q.jsxs)(`td`,{children:[e.active,`/`,e.neurons]})]},e.limb))})]}),v.length>0&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`h4`,{className:`flybody-heading`,children:p(`body.jointBalance`)}),(0,Q.jsx)(`ul`,{className:`joint-list`,children:v.map(e=>(0,Q.jsxs)(`li`,{children:[(0,Q.jsxs)(`span`,{className:`joint-name`,children:[m(e.limb),` `,e.key]}),(0,Q.jsx)(`span`,{className:`joint-track`,children:(0,Q.jsx)(`span`,{className:`joint-fill`,style:{width:`${Math.abs(e.angle)*50}%`,[e.angle>=0?`left`:`right`]:`50%`,background:e.angle>=0?`#26d8ff`:`#ff7e3e`}})}),(0,Q.jsxs)(`span`,{className:`joint-value`,children:[e.angle>=0?`+`:``,e.angle.toFixed(2)]})]},`${e.limb}-${e.key}`))})]}),e&&Object.keys(e.sensoryInvolved).length>0&&(0,Q.jsxs)(`p`,{className:`bodymap-sense`,children:[p(`body.sensoryReached`),`: `,Object.entries(e.sensoryInvolved).sort((e,t)=>t[1].amount-e[1].amount).slice(0,5).map(([e,t])=>`${h(e)} ${t.active}`).join(` · `)]}),l&&(0,Q.jsxs)(`p`,{className:`flybody-note`,children:[l.segments,p(`body.segments`),` · `,l.joints,p(`body.drivenJoints`),` · `,` `,l.tris.toLocaleString(),p(`body.triangles`)]})]})]})}var bu=e=>e.instance||e.type||`body ${e.bodyId}`;function xu({meta:e,settings:t,onSettings:n,onSeeds:r,onPreset:i,onRun:a,running:o,seedCount:s}){let{t:c}=vl(),l=(e,r)=>n({...t,[e]:r});return(0,Q.jsxs)(`div`,{className:`controls-panel`,children:[(0,Q.jsxs)(`fieldset`,{children:[(0,Q.jsx)(`legend`,{children:c(`ctrl.experiment`)}),(0,Q.jsx)(`div`,{className:`preset-grid`,children:e.presets.map(e=>(0,Q.jsxs)(`button`,{className:`preset`,title:c(`preset.`+e.id+`.detail`),onClick:()=>i(e,c(`preset.`+e.id+`.title`)),children:[(0,Q.jsx)(`strong`,{children:c(`preset.`+e.id+`.title`)}),(0,Q.jsxs)(`span`,{children:[e.seeds.length,c(`ctrl.neurons`)]})]},e.id))})]}),(0,Q.jsxs)(`fieldset`,{children:[(0,Q.jsx)(`legend`,{children:c(`ctrl.propagation`)}),(0,Q.jsxs)(`div`,{className:`row`,children:[(0,Q.jsxs)(`label`,{children:[c(`ctrl.mode`),(0,Q.jsxs)(`select`,{value:t.mode,disabled:!0,onChange:e=>l(`mode`,e.target.value),children:[(0,Q.jsx)(`option`,{value:`path`,children:c(`ctrl.modePath`)}),(0,Q.jsx)(`option`,{value:`rate`,children:c(`ctrl.modeRate`)})]})]}),(0,Q.jsxs)(`label`,{children:[c(`ctrl.direction`),(0,Q.jsxs)(`select`,{value:t.direction,disabled:!0,onChange:e=>l(`direction`,e.target.value),children:[(0,Q.jsx)(`option`,{value:`downstream`,children:c(`ctrl.down`)}),(0,Q.jsx)(`option`,{value:`upstream`,children:c(`ctrl.up`)})]})]})]}),t.mode===`path`?(0,Q.jsxs)(`div`,{className:`row`,children:[(0,Q.jsxs)(`label`,{children:[c(`ctrl.hops`),` `,t.hops,(0,Q.jsx)(`input`,{type:`range`,min:`1`,max:5,step:`1`,value:Math.min(t.hops,5),onChange:e=>l(`hops`,Number(e.target.value))})]}),(0,Q.jsxs)(`label`,{className:`is-fixed`,children:[c(`ctrl.decay`),` `,t.decay.toFixed(2),(0,Q.jsx)(`input`,{type:`range`,min:`0.3`,max:`1`,step:`0.05`,value:t.decay,disabled:!0,onChange:e=>l(`decay`,Number(e.target.value))})]})]}):(0,Q.jsxs)(`div`,{className:`row`,children:[(0,Q.jsxs)(`label`,{children:[c(`ctrl.duration`),` `,t.duration.toFixed(2),` s`,(0,Q.jsx)(`input`,{type:`range`,min:`0.1`,max:`3`,step:`0.1`,value:t.duration,onChange:e=>l(`duration`,Number(e.target.value))})]}),(0,Q.jsxs)(`label`,{children:[c(`ctrl.tau`),` `,(t.tau*1e3).toFixed(0),` ms`,(0,Q.jsx)(`input`,{type:`range`,min:`0.005`,max:`0.2`,step:`0.005`,value:t.tau,onChange:e=>l(`tau`,Number(e.target.value))})]}),(0,Q.jsxs)(`label`,{children:[c(`ctrl.gain`),` `,t.gain.toFixed(1),(0,Q.jsx)(`input`,{type:`range`,min:`0.2`,max:`8`,step:`0.2`,value:t.gain,onChange:e=>l(`gain`,Number(e.target.value))})]}),(0,Q.jsxs)(`label`,{children:[c(`ctrl.stim`),` `,(t.stim*1e3).toFixed(0),` ms`,(0,Q.jsx)(`input`,{type:`range`,min:`0.01`,max:`1`,step:`0.01`,value:t.stim,onChange:e=>l(`stim`,Number(e.target.value))})]})]}),(0,Q.jsxs)(`div`,{className:`row`,children:[(0,Q.jsxs)(`label`,{className:`is-fixed`,children:[c(`ctrl.minWeight`),` `,t.min_weight,(0,Q.jsx)(`input`,{type:`range`,min:`1`,max:`50`,step:`1`,value:t.min_weight,disabled:!0,onChange:e=>l(`min_weight`,Number(e.target.value))})]}),(0,Q.jsxs)(`label`,{className:`is-fixed`,children:[c(`ctrl.inhibition`),` x`,t.inhibition.toFixed(1),(0,Q.jsx)(`input`,{type:`range`,min:`0`,max:`3`,step:`0.1`,value:t.inhibition,disabled:!0,onChange:e=>l(`inhibition`,Number(e.target.value))})]})]}),(0,Q.jsx)(`p`,{className:`fixed-note`,children:c(`static.fixedNote`)})]})]})}var Su=[`optic`,`central`,`descending`,`vnc`,`other`],Cu={optic:`#81b5c8`,central:`#cfcac0`,descending:`#dfb672`,vnc:`#af9bc3`,other:`#6c7777`};function wu({result:e,frameIndex:t}){let{t:n,role:r,part:i,group:a}=vl();if(!e)return(0,Q.jsx)(`p`,{className:`muted`,children:n(`flow.empty`)});let o=e.summary,s=e.frames[Math.min(t,e.frames.length-1)];return(0,Q.jsxs)(`div`,{className:`flow`,children:[(0,Q.jsxs)(`div`,{className:`flow-stats`,children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`strong`,{children:s.active.toLocaleString()}),` `,n(`flow.carrying`)]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`strong`,{children:o.reached.toLocaleString()}),` `,n(`flow.reached`)]}),(0,Q.jsxs)(`span`,{children:[n(`flow.descending`),` `,(0,Q.jsx)(`strong`,{children:o.gateway.descending})]}),(0,Q.jsxs)(`span`,{children:[n(`flow.ascending`),` `,(0,Q.jsx)(`strong`,{children:o.gateway.ascending})]}),(0,Q.jsxs)(`span`,{children:[n(`flow.motor`),` `,(0,Q.jsx)(`strong`,{children:o.gateway.motor})]}),(0,Q.jsxs)(`span`,{children:[n(`flow.sensory`),` `,(0,Q.jsx)(`strong`,{children:o.gateway.sensory})]})]}),(0,Q.jsx)(`div`,{className:`flow-bars`,children:Su.filter(e=>o.byGroup[e]).map(e=>{let t=o.byGroup[e];return(0,Q.jsxs)(`div`,{className:`flow-bar`,children:[(0,Q.jsx)(`span`,{className:`flow-name`,children:a(e)}),(0,Q.jsx)(`span`,{className:`flow-track`,children:(0,Q.jsx)(`span`,{className:`flow-fill`,style:{width:`${Math.round(t.share*100)}%`,background:Cu[e]}})}),(0,Q.jsxs)(`span`,{className:`flow-value`,children:[(t.share*100).toFixed(1),`% · `,t.count]})]},e)})}),(0,Q.jsx)(`h4`,{children:n(`flow.strongest`)}),(0,Q.jsx)(`ol`,{className:`top-list`,children:o.topNeurons.slice(0,12).map(e=>(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`span`,{className:(e.activation??0)<0?`neg`:`pos`,children:(e.activation??0).toFixed(3)}),bu(e),` `,(0,Q.jsxs)(`em`,{children:[r(e.role),e.part===`other`?``:` · ${i(e.part)} ${e.side}`]})]},e.bodyId))})]})}function Tu(){let{t:e}=vl();return(0,Q.jsxs)(`footer`,{children:[(0,Q.jsxs)(`span`,{children:[e(`attr.builtWith`),` `,(0,Q.jsx)(`a`,{href:`https://github.com/cobanov/fly-connectome-template`,children:`fly-connectome-template`}),` `,e(`attr.by`),` `,(0,Q.jsx)(`a`,{href:`https://github.com/cobanov`,children:`Mert Cobanov`}),`. `,(0,Q.jsx)(`a`,{href:gu(`TEMPLATE-LICENSE.txt`),children:e(`attr.license`)})]}),(0,Q.jsxs)(`span`,{children:[e(`attr.data`),`: `,(0,Q.jsx)(`a`,{href:`https://male-cns.janelia.org/`,children:`MaleCNS · CC BY 4.0`}),` · `,e(`attr.body`),`: `,(0,Q.jsx)(`a`,{href:`https://github.com/TuragaLab/flybody`,children:`Flybody · Apache 2.0`})]})]})}function Eu(){let[e,t]=(0,_.useState)(_l);return(0,_.useEffect)(()=>{let e=e=>{if(e.origin!==window.location.origin)return;let n=e.data;n?.type===`brainlab-language`&&t(n.language===`ko`?`ko`:`en`)};return window.addEventListener(`message`,e),window.parent?.postMessage({type:`fly-brain-ready`},window.location.origin),()=>window.removeEventListener(`message`,e)},[]),(0,Q.jsx)(hl.Provider,{value:e,children:(0,Q.jsx)(Du,{lang:e,onLang:t})})}function Du({lang:e,onLang:t}){let{t:n,limb:r,role:i,part:a}=vl(),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(Sl),[f,p]=(0,_.useState)([]),[m,h]=(0,_.useState)(``),[g,v]=(0,_.useState)(null),[y,b]=(0,_.useState)(null),[x,S]=(0,_.useState)(0),[C,w]=(0,_.useState)(!1),[T,E]=(0,_.useState)(!1),[D,O]=(0,_.useState)(``),[k,A]=(0,_.useState)(`search`),j=(0,_.useRef)(u);(0,_.useEffect)(()=>{j.current=u},[u]),(0,_.useEffect)(()=>{Promise.all([Ol(),Fl()]).then(([e,t])=>{s(e),l(t)}).catch(e=>O(`${e}. ${n(`error.apiHint`)}`))},[]);let M=(0,_.useCallback)((e,t)=>{p(e),h(t),e.length===1&&v(e[0])},[]),ee=(0,_.useCallback)(async e=>{let t=e??f;if(t.length!==0){E(!0),O(``);try{let e=await Il(t,j.current);b(e),S(0),w(!0)}catch(e){O(e instanceof Pl?n(`static.cannotCompute`):String(e))}finally{E(!1)}}},[f,n]),te=(0,_.useCallback)(async(e,t)=>{let n={...j.current,mode:e.mode,direction:e.direction,hops:e.hops??j.current.hops};j.current=n,d(n),E(!0),O(``);try{let r=await Ml(e,n);b(r),p(r.seeds),h(t),ne.current={kind:`preset`,preset:e,label:t},F(null),v(null),S(0),w(!0)}catch(e){O(String(e))}finally{E(!1)}},[]),N=(0,_.useCallback)(async(e,t)=>{E(!0),O(``);try{let n=await Nl(e,j.current);b(n),p(n.seeds),h(t),ne.current={kind:`population`,id:e,label:t},v(null),S(0),w(!0)}catch(e){O(String(e))}finally{E(!1)}},[]),[P,F]=(0,_.useState)(null),ne=(0,_.useRef)(null),re=(0,_.useCallback)((e,t)=>{v(e),A(`neuron`),El(e).then(t=>{F(t),p([e]),h(t?.name||`body ${e}`)}).catch(e=>O(String(e)))},[ee]),ie=(0,_.useCallback)(e=>e.kind===`population`?N(e.id,e.label):te({...e.preset,hops:void 0},e.label),[te,N]),I=u.hops,ae=(0,_.useRef)(!0);(0,_.useEffect)(()=>{if(ae.current){ae.current=!1;return}let e=setTimeout(()=>{let e=ne.current;e&&(e.kind,ie(e))},250);return()=>clearTimeout(e)},[I]);let L=y?.frames??[];(0,_.useEffect)(()=>{if(!C||L.length===0)return;let e=setInterval(()=>{S(e=>e>=L.length-1?(w(!1),e):e+1)},y?.mode===`rate`?60:420);return()=>clearInterval(e)},[C,L.length,y?.mode]);let R=L[Math.min(x,Math.max(0,L.length-1))]??null,oe=(0,_.useMemo)(()=>!y||!R?n(`toolbar.noSim`):y.mode===`rate`?`t = ${R.time.toFixed(3)} s`:`${n(`toolbar.hop`)} ${R.time.toFixed(0)} ${n(`toolbar.of`)} ${y.frames.length-1}`,[y,R,e]);return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsxs)(`header`,{children:[(0,Q.jsx)(`h1`,{children:n(`app.title`)}),(0,Q.jsx)(`span`,{children:n(`app.subtitle`)}),!1,(0,Q.jsx)(`button`,{className:`manual-button`,title:n(`app.manualTip`),onClick:()=>window.open(gu(n(`app.manualFile`)),`fly-sim-manual`,`noopener,width=1180,height=900`),children:n(`app.manual`)}),!1]}),(0,Q.jsxs)(`main`,{children:[(0,Q.jsxs)(`div`,{className:`toolbar`,children:[(0,Q.jsxs)(`span`,{className:`status`,children:[n(`toolbar.stimulating`),`: `,(0,Q.jsx)(`strong`,{children:m||n(`toolbar.nothing`)}),` ·`,` `,(y?.seedCount??f.length).toLocaleString(),e===`ko`?``:` `,f.length===1?n(`toolbar.seed`):n(`toolbar.seeds`),` · `,u.direction===`downstream`?n(`ctrl.down`):n(`ctrl.up`),` · `,oe]}),(0,Q.jsxs)(`div`,{className:`controls`,children:[(0,Q.jsx)(`button`,{onClick:()=>{S(0),w(!1)},children:n(`toolbar.reset`)}),(0,Q.jsx)(`button`,{disabled:L.length===0,onClick:()=>{x>=L.length-1&&S(0),w(!C)},children:n(C?`toolbar.pause`:`toolbar.play`)}),(0,Q.jsx)(`button`,{disabled:T||f.length===0,onClick:()=>void ee(),children:n(T?`toolbar.running`:`toolbar.rerun`)}),(0,Q.jsx)(`button`,{disabled:f.length===0,onClick:()=>{p([]),b(null),h(n(`toolbar.nothing`))},children:n(`toolbar.clear`)})]})]}),D&&(0,Q.jsx)(`p`,{className:`error`,role:`alert`,children:D}),(0,Q.jsxs)(`p`,{className:`static-note`,children:[(0,Q.jsx)(`strong`,{children:n(`static.badge`)}),` `,n(`static.why`)]}),(0,Q.jsxs)(`div`,{className:`sim-workbench`,children:[(0,Q.jsxs)(`section`,{className:`panel cns-panel`,children:[(0,Q.jsxs)(`h2`,{children:[n(`panel.cns`),(0,Q.jsx)(`span`,{children:o?`${o.renderable.toLocaleString()}${n(`panel.cnsSomata`)}`:`…`})]}),c?(0,Q.jsx)(xl,{cloud:c,frame:R,seeds:f,selected:g,onPick:re}):(0,Q.jsx)(`p`,{className:`loading`,role:`status`,children:n(`panel.loadingAnatomy`)}),(0,Q.jsxs)(`div`,{className:`panel-bottom`,children:[(0,Q.jsx)(`span`,{children:o?`${o.edges.toLocaleString()}${n(`panel.cnsEdges`)}`:``}),(0,Q.jsx)(`span`,{children:n(`panel.cnsOrient`)})]})]}),(0,Q.jsxs)(`section`,{className:`panel body-panel`,children:[(0,Q.jsxs)(`h2`,{children:[n(`panel.body`),` `,(0,Q.jsx)(`span`,{children:n(`panel.bodyTag`)})]}),(0,Q.jsx)(`div`,{className:`body-inner`,children:(0,Q.jsx)(yu,{summary:y?.summary??null,posture:R?.posture??y?.summary?.posture??null,direction:y?.direction??`downstream`})}),(0,Q.jsxs)(`div`,{className:`panel-bottom`,children:[(0,Q.jsx)(`span`,{children:n(`panel.bodyPosed`)}),(0,Q.jsx)(`span`,{children:n(`panel.bodyDrag`)})]})]}),(0,Q.jsxs)(`section`,{className:`panel circuit-panel`,children:[(0,Q.jsxs)(`h2`,{children:[n(`circuit.title`),` `,(0,Q.jsx)(`span`,{children:n(`circuit.tag`)})]}),(0,Q.jsx)(ql,{activity:R?.circuit??null,onStimulate:N,running:T})]}),(0,Q.jsxs)(`section`,{className:`panel tools-panel`,children:[(0,Q.jsx)(`h2`,{children:n(`panel.experiment`)}),(0,Q.jsx)(`div`,{className:`tools-inner`,children:o&&(0,Q.jsx)(xu,{meta:o,settings:u,onSettings:d,onSeeds:(e,t)=>{M(e,t),ee(e)},onPreset:te,onRun:()=>void ee(),running:T,seedCount:f.length})})]}),(0,Q.jsxs)(`section`,{className:`panel detail-panel`,children:[(0,Q.jsxs)(`h2`,{children:[n(`panel.detail`),(0,Q.jsx)(`span`,{className:`tabs`,children:[`search`,`neuron`,`flow`].map(e=>(0,Q.jsx)(`button`,{"aria-pressed":k===e,onClick:()=>A(e),children:n(`tab.${e}`)},e))})]}),(0,Q.jsxs)(`div`,{className:`detail-inner`,children:[k===`neuron`&&(0,Q.jsx)(`div`,{className:`inspector`,children:P?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`h3`,{children:P.name||`body ${P.bodyId}`}),(0,Q.jsxs)(`dl`,{className:`facts`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:n(`insp.bodyId`)}),(0,Q.jsx)(`dd`,{children:P.bodyId})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:n(`insp.role`)}),(0,Q.jsx)(`dd`,{children:i(P.role)})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:n(`insp.bodyPart`)}),(0,Q.jsxs)(`dd`,{children:[a(P.part),` `,P.side]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:n(`insp.transmitter`)}),(0,Q.jsx)(`dd`,{children:P.nt})]})]}),P.population&&(0,Q.jsx)(`button`,{className:`run`,disabled:T,onClick:()=>void N(P.population,P.population),children:n(`static.runIts`)})]}):(0,Q.jsx)(`p`,{className:`muted`,children:n(`insp.empty`)})}),k===`search`&&(0,Q.jsx)(`p`,{className:`muted`,children:n(`static.noSearch`)}),!1,!1,k===`flow`&&(0,Q.jsx)(wu,{result:y,frameIndex:x})]})]})]}),(0,Q.jsx)(`section`,{className:`model-status`,children:(0,Q.jsxs)(`label`,{children:[n(`step.label`),(0,Q.jsx)(`input`,{type:`range`,min:`0`,max:Math.max(0,L.length-1),step:`1`,value:x,disabled:L.length===0,onChange:e=>{w(!1),S(Number(e.target.value))}}),(0,Q.jsx)(`span`,{children:oe})]})}),(0,Q.jsxs)(`details`,{children:[(0,Q.jsx)(`summary`,{children:n(`notes.title`)}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`strong`,{children:n(`notes.measuredLabel`)}),` `,n(`notes.measured`,{nodes:o?.nodes.toLocaleString()??`—`,edges:o?.edges.toLocaleString()??`—`})]}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`strong`,{children:n(`notes.modelledLabel`)}),` `,n(`notes.modelled`)]}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`strong`,{children:n(`notes.bodyLabel`)}),` `,n(`notes.body`)]}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`strong`,{children:n(`notes.directionLabel`)}),` `,n(`notes.direction`)]}),(0,Q.jsxs)(`p`,{children:[n(`notes.credit`),(0,Q.jsx)(`a`,{href:`https://male-cns.janelia.org/download/`,children:n(`notes.creditLink`)}),n(`notes.creditTail`)]})]})]}),(0,Q.jsx)(Tu,{})]})}v.createRoot(document.getElementById(`root`)).render((0,Q.jsx)(_.StrictMode,{children:(0,Q.jsx)(Eu,{})}));